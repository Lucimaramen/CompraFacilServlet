                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select name="departamento" id="departamento">
                            ...
                            <option value="adminostrativo">Administrativo</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control col-8" id="assunto" placeholder="Informe o assunto" name="assunto">
                    </div>
                    <div class="form-group ">
                        <label ><b>Observação</b></label><br>
                        <textarea style="resize: none;" name="observacao" id="observacao" rows="5" cols="75" ></textarea>
                    </div>    
                    <button type="button" class="btn btn-button mt-4 col-2">Enviar</button>
                </div>  
            </div>
        </div>     
    </form>
