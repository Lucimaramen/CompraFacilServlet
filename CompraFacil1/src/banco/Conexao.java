...
public class Conexao {
    ...
    public Conexao() {
        // String de conexao
        this.url = "jdbc:mysql://127.0.0.1:3306/mydb?useSSL=false&useTimezone=true&serverTimezone=UTC";
        this.usuario = "lucimara";   // Informe o usuario e senha
        this.senha = "lucimara1"; // do seu banco de dados
